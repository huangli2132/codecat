...
SKILL_FILE_CREATION_GUIDE = """When creating Pico skill files at .codecat/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${CODECAT_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".codecat" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".codecat" / "skills", "project"),
    ]
