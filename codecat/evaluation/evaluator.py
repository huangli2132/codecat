...
class BenchmarkEvaluator:
    def __init__(
        ...
        self.workspace_root = Path(workspace_root) if workspace_root is not None else Path(
            tempfile.mkdtemp(prefix="codecat-benchmark-")
        )
    ...
    def run_task(self, task):
        ...
        session_store = SessionStore(fixture_copy_root / ".codecat" / "sessions")
        run_store = RunStore(fixture_copy_root / ".codecat" / "runs")
