...
def test_run_evidence_reads_trace_report_and_session_artifacts(tmp_path):
    workspace = tmp_path
    run_dir = workspace / ".codecat" / "runs" / "run_1"
    session_dir = workspace / ".codecat" / "sessions"
        ...
        json.dumps(
            {
                ...
                "runtime_reminders": [{"artifact_path": ".codecat/runs/run_1/artifacts/fallback.txt"}],
                ...
                json.dumps(
                    {
                        "event": "tool_executed",
                        "name": "run_shell",
                        "full_output_artifact": ".codecat/runs/run_1/artifacts/output.txt",
                    }
                ),
    ...
    assert evidence.full_output_artifacts() == [
        ".codecat/runs/run_1/artifacts/output.txt",
        ".codecat/runs/run_1/artifacts/fallback.txt",
    ]
